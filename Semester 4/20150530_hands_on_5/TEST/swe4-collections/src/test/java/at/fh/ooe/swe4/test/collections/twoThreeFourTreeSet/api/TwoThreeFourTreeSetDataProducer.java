 ...
 * where dedicated trees are build via the {@link NMKTreeNode} model.
 * 
...
public class TwoThreeFourTreeSetDataProducer {
	...
	public static class TestData {
		...
		public final NMKTreeNode<Integer> root;
		...
		public TestData(final List<Integer> orderedValues,
				...
				final NMKTreeNode<Integer> root, final int levels) {
			super();
	...
	public static TestData createTestData(final TestCase testCase) {
		...
		case TREE_1:
			...
			// ------------------------------------------------
			final NMKTreeNode<Integer> l1 = new NMKTreeNode<Integer>();
			l1.addKey(1);
			l1.addKey(2);
			orderedValues.add(1);
			orderedValues.add(2);

			final NMKTreeNode<Integer> l2 = new NMKTreeNode<Integer>();
			l2.addKey(4);
			l2.addKey(5);
			orderedValues.add(4);
			orderedValues.add(5);

			final NMKTreeNode<Integer> r1 = new NMKTreeNode<Integer>(7);
			orderedValues.add(7);

			final NMKTreeNode<Integer> r2 = new NMKTreeNode<Integer>();
			r2.addKey(9);
			r2.addKey(10);
			orderedValues.add(9);
			orderedValues.add(10);

			final NMKTreeNode<Integer> r3 = new NMKTreeNode<Integer>();
			r2.addKey(12);
			r2.addKey(13);
			orderedValues.add(12);
			orderedValues.add(13);

			final NMKTreeNode<Integer> l1l2 = new NMKTreeNode<Integer>(
					3);
			l1l2.addChild(l1);
			l1l2.addChild(l2);
			orderedValues.add(3);

			final NMKTreeNode<Integer> r1r2 = new NMKTreeNode<Integer>(
					8);
			r1r2.addChild(r1);
			r1r2.addChild(r2);
			orderedValues.add(8);

			final NMKTreeNode<Integer> root = new NMKTreeNode<Integer>(
					6);
			root.addChild(l1l2);
			root.addChild(r1r2);
			orderedValues.add(6);
		...
		case TREE_2:
			...
			// ----------------------------------------------------------------
			final NMKTreeNode<Integer> _l1 = new NMKTreeNode<Integer>();
			_l1.addKey(1);
			_l1.addKey(2);
			_l1.addKey(3);
			orderedValues.add(1);
			...
			final NMKTreeNode<Integer> _l2 = new NMKTreeNode<Integer>();
			_l2.addKey(5);
			_l2.addKey(6);
			_l2.addKey(7);
			orderedValues.add(5);
			...
			final NMKTreeNode<Integer> _l3 = new NMKTreeNode<Integer>();
			_l3.addKey(9);
			_l3.addKey(10);
			_l3.addKey(11);
			orderedValues.add(9);
			...
			final NMKTreeNode<Integer> _r1 = new NMKTreeNode<Integer>();
			_r1.addKey(13);
			_r1.addKey(14);
			_r1.addKey(15);
			orderedValues.add(13);
			...
			final NMKTreeNode<Integer> _r2 = new NMKTreeNode<Integer>();
			_r2.addKey(17);
			_r2.addKey(18);
			_r2.addKey(19);
			...
			final NMKTreeNode<Integer> _r3 = new NMKTreeNode<Integer>();
			_r3.addKey(21);
			_r3.addKey(22);
			_r3.addKey(23);
			...
			final NMKTreeNode<Integer> _l1l2l3 = new NMKTreeNode<Integer>();
			...
			final NMKTreeNode<Integer> _r1r2r3 = new NMKTreeNode<Integer>();
			...
			final NMKTreeNode<Integer> _root = new NMKTreeNode<Integer>();
