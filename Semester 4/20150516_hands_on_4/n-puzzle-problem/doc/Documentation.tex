...
Hier sind die Loggin Konfigurationen für \emph{log4j} enthalten.
\begin{code}
...
Diese Klasse dient als Basis für die LoggerWatcher und kapselt alle gemeinsamen Konfigurationen und Ressource.
\begin{code}
...
Folgend ist der Source der implementierten Exceptions.
...
\begin{figure}[h]
	...
	\caption
	{Diese Abbildung zeigt die Resultate zur Verfügung gestellten Tests für die \inlineJavaSource{SearchNode<T>} angeführt}
\end{figure}
\newpage
